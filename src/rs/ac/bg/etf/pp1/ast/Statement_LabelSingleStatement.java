...
public class Statement_LabelSingleStatement extends Statement {

    private Label Label;
    private SingleStatement SingleStatement;

    public Statement_LabelSingleStatement (Label Label, SingleStatement SingleStatement) {
        this.Label=Label;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Statement_LabelSingleStatement(\n");
