...
public class MultipleDeclaration extends DeclarationList {

    private DeclarationList DeclarationList;
    private DeclarationItem DeclarationItem;

    public MultipleDeclaration (DeclarationList DeclarationList, DeclarationItem DeclarationItem) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleDeclaration(\n");
