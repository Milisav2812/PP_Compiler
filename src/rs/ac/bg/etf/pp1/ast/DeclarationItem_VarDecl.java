...
public class DeclarationItem_VarDecl extends DeclarationItem {

    private VarDeclaration VarDeclaration;

    public DeclarationItem_VarDecl (VarDeclaration VarDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationItem_VarDecl(\n");
