...
public class VarDeclaration_Item extends VarDeclarationError {

    private VarDeclarationItem VarDeclarationItem;

    public VarDeclaration_Item (VarDeclarationItem VarDeclarationItem) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclaration_Item(\n");
